...
expected_required_columns(table_name, column_name) as (
  values
    ...
    ('inventory_locations', 'location_type'),
    ('inventory_movements', 'movement_type'),
    ('job_rental_contracts', 'billing_cycle_days'),
    ('job_rental_contracts', 'next_billing_date'),
    ('job_rental_lines', 'agreed_rate'),
    ('job_rental_lines', 'rate_unit'),
    ('rental_billing_runs', 'subtotal'),
    ...
    ('support_packet_access_log', 'support_packet_id'),
    ('support_packet_access_log', 'actor_user_id'),
    ('support_packet_access_log', 'access_type'),
    ...
    ('context_handoff_events', 'payload'),
    ('context_handoff_events', 'idempotency_key'),
    ('context_handoff_events', 'metadata'),
    ('context_handoff_events', 'request_id'),
