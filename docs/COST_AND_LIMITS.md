...
| Reserved IP `159.203.51.158`               | DO reserved IP, attached              | Free while attached to a running droplet                   | $0.00      |
...
| Backup retention spillover                   | 30 days local                   | `/app/backups/postgres` > 75% of disk | Wire off-host copy to Spaces (script TODO in `docs/DR_RESTORE.md` Open Work)                                  | $0 (compute) |
...
**~$101/month.** (Plus ~$0.87/mo amortized domain renewal — call it $102/mo all-in.)
