...
export const CORS_ALLOW_HEADERS =
  'content-type, authorization, baggage, sentry-trace, traceparent, x-request-id, x-sitelayer-company-id, x-sitelayer-company-slug, x-sitelayer-user-id, x-sitelayer-act-as, x-sitelayer-capture-session-id, idempotency-key'
