// Mirror of apps/api/src/email.ts — kept in sync so the worker can send
// notifications without pulling in the api workspace. Keep the two files
// byte-identical below the import line.
